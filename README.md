...
Specification Analysis — Understand requirements and derive state diagrams or block diagrams
RTL Coding — Implement in SystemVerilog using always_ff for sequential and always_comb for combinational logic
Testbench Development — Build self-checking testbenches with VCD dump for waveform analysis
Simulation & Verification — Run with Icarus Verilog, analyze in GTKWave, verify against expected behavior
Documentation — Write comprehensive README with architecture, timing diagrams, and lessons learned
